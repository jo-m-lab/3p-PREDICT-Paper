...
#sort patients by antiTNFresponse
#meta <- read_tsv('/Users/kkimler/Projects/PREDICT/metadata/20200630_clmeta_CD14_all.tsv')
#meta <- meta %>% count(patient,antiTNF_response)
#meta <- meta %>% arrange(factor(antiTNF_response,levels=c('NOA','RESP','PR')))
#pxc <- pxc[,c(meta$patient)]
